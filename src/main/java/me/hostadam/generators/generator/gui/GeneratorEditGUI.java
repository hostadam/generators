...
public class GeneratorEditGUI extends GeneratorGUI {
    ...
    public void open() {
        ...
        this.inventory.setItem(10, new ItemBuilder(Material.NAME_TAG).withName("§e§lMax Generations").withLore("§7To change how many times this generator§7", "§7should generate before disappearing, §fclick here§7.", " ", "§8→ §eCurrent§7: " + this.generator.getMaxGenerations()).build());
        this.inventory.setItem(11, new ItemBuilder(Material.REPEATER).withName("§e§lInterval").withLore("§7To change how often the generator should", "§7generate, §fclick here §7and enter in chat (in ticks).", " ", "§8→ §eCurrent§7: " + DurationFormatUtils.formatDurationWords(this.generator.getInterval(), true, true)).build());
        this.inventory.setItem(12, new ItemBuilder(Material.CLOCK).withName("§e§lMin Delay").withLore("§7To change the lowest delay until the next generation", "§7§fclick here §7and enter in chat (in ticks).", " ", "§8→ §eCurrent§7: " + DurationFormatUtils.formatDurationWords(this.generator.getMinDelay(), true, true)).build());
        this.inventory.setItem(13, new ItemBuilder(Material.CLOCK).withName("§e§lMax Delay").withLore("§7To change the max delay until the next generation", "§7§fclick here §7and enter in chat (in ticks).", " ", "§8→ §eCurrent§7: " + DurationFormatUtils.formatDurationWords(this.generator.getMaxDelay(), true, true)).build());
        this.inventory.setItem(14, new ItemBuilder(Material.CLOCK).withName("§e§lDuration").withLore("§7To change how long until the generator", "§7should remove itself, §fclick here §7and enter in chat (in ticks).", " ", "§8→ §eCurrent§7: " + DurationFormatUtils.formatDurationWords(this.generator.getDuration(), true, true)).build());
